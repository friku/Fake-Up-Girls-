...
with tf.device('/gpu:%d' % gpu_id):
    ''' models '''
    generator = models.generator_big_bn
    discriminator = models.discriminator_wgan_gp_big_ln
    ''' graph '''
    # inputs
...
dir_name = "tik_"+str(imgsize)+"_big_pool_lrelu_res_batch64_lrd2^-4_lrg2^-4_ch64"
