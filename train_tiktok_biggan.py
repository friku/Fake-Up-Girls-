...
with tf.device('/gpu:%d' % gpu_id):
    ''' models '''
    generator = models.generator_self_deep
    discriminator = models.discriminator_wgan_gp_self_deep
    ''' graph '''
    # inputs
...
dir_name = "tik_"+str(imgsize)+"_big_batch64_lrd2^-4_lrg2^-4_ch64_6res_noup"
